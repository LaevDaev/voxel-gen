...
namespace vvox
{
    ...
    VvoxPipeline::~VvoxPipeline()
    {
        vkDestroyShaderModule(vvoxDevice.device(), vertShaderModule, nullptr);
        vkDestroyShaderModule(vvoxDevice.device(), fragShaderModule, nullptr);
        vkDestroyPipeline(vvoxDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    void VvoxPipeline::createGraphicsPipeline(const std::string &vertFilepath, const std::string &fragFilepath, const PipelineConfigInfo &configInfo)
    {
        ...
        auto bindingDescriptions = VvoxModel::Vertex::getBindingDescriptions();
        auto attributeDescriptions = VvoxModel::Vertex::getAttributeDescriptions();
    ...
    void VvoxPipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo)
    {
